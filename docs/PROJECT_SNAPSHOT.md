# QuantLab — Project Snapshot (Phase 55.0)

A one-page handoff doc. Facts verified against the repo when written
(version label `4.73.0-dev`); counts drift as phases land — re-verify before
public use.
...
- **Product Workflow:** Scenario Studio, Research Workspace, Experiment
  ...
  Cost & Capacity, Data Reliability Center, QA Command Center,
...
Diagnostics, Regime Diagnostics, and Cost & Capacity views (local-first, plus a manually triggered CI workflow —
