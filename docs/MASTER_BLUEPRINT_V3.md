...
| Reproducible Backtest Permalinks / config hash | planned |
| Robustness Lab (bootstrap Monte Carlo, deflated Sharpe, sensitivity heatmaps, PBO if feasible) | planned |
...
2. Reproducible Backtest Permalinks / Config Hash
3. Robustness Lab v1
