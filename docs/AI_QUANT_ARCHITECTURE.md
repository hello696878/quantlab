...
## Appendix E — Phase 4 ML Signal Lab Plan
...
the **existing** Phase 3 backtest (which already enforces t+1 execution). This
appendix is a plan — implementation lands in commits 1–5.
