...
| **Options & Volatility Lab** | European Black–Scholes pricing + Greeks · implied-volatility solver (bisection, no-arb bounds) · single & multi-leg expiration payoff diagrams · 10 strategy presets · **CRR binomial tree** with European/American exercise, early-exercise diagnostic & Black–Scholes convergence — deterministic & educational, no live chains |
