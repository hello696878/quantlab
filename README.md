...
| **Yield Curve Lab** | Zero rates · discount factors (annual / semiannual / continuous) · forward rates · linear interpolation · curve **shocks** (parallel / steepener / flattener / butterfly) · fixed-rate **bond pricing** (YTM or curve discounting) · Macaulay / modified **duration** · **DV01** · **convexity** — synthetic/manual curves, no live rates feed, no swap-curve bootstrapping |
