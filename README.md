...
- **Options Lab v1 is a calculator, not an options risk engine.** It supports European Black–Scholes, Greeks, bisection IV, terminal payoff diagrams, simplified CRR tree pricing for European/American exercise, GBM Monte Carlo pricing for European/Asian/barrier payoffs, and a manual/synthetic IV surface with SVI research fit — no live chains, assignment, discrete-dividend/corporate-action modelling, stochastic volatility, arbitrage-free calibration, liquidity, or transaction costs.
