...
| **Real Estate Lab** | **Income-property + REIT analytics** on a deterministic static sample: **EGI / NOI** · in-place & exit **cap rate** valuation · **mortgage amortization** (with optional interest-only) · **LTV** · **DSCR** · **cash-on-cash** · levered cash flow · **IRR** (deterministic solver) · **equity multiple** · six **stress scenarios** (base · rent upside · vacancy shock · cap-rate expansion · interest-rate shock · downside combo) · simple **REIT NAV** discount/premium · P/FFO · dividend yield · **Mortgage & MBS prepayment** (CPR→SMM · simplified **PSA** ramp · MBS cash-flow decomposition · **WAL** · price from discount rate · **duration / convexity** approximations · rate & prepayment-speed stress scenarios) · editable assumptions — static sample data, not a production appraisal/underwriting/MBS-valuation tool, no live mortgage rates or MBS prices, not investment / tax / legal / lending advice |
| **Futures & Commodities Lab** | **Deterministic futures/commodities analytics** on four sample commodities (crude, gold, natural gas, wheat): **cost-of-carry** pricing `F = S·e^{(r+u−y)T}` · **implied convenience yield** · **futures-curve shape** (contango / backwardation / mixed) · **basis** & annualized basis · **roll yield** · **calendar spreads** · contract **notional / initial & maintenance margin / leverage** · long/short **P&L** & return on margin · eight **commodity stress scenarios** (spot rally/selloff · contango steepening · backwardation/storage/convenience shocks · margin stress) · editable assumptions — static sample data, no live futures/commodity prices, not a production risk engine, no exchange/broker integration, not investment / trading advice |
| **Volatility Surface & Variance Swap Lab** | **Deterministic derivatives-vol analytics** on a sample SPX-like option chain (BS-generated mid prices): **implied-vol inversion** (reuses the Options Lab Black-Scholes bisection solver) · **smile / skew / term structure** · 2-D **volatility surface** (maturity × strike) · **realized-vol** comparison & implied−realized spread · **variance-swap fair strike** (simplified educational option-strip approximation, *not* official VIX methodology) · **vega exposure** (by maturity & moneyness) · eight **volatility scenarios** (parallel up/down · skew steepening/flattening · short-/long-dated repricing · spot-selloff-with-vol-up) · editable underlying — static sample data, no live option chains, not a production risk engine, no exchange/broker integration, not investment / trading advice |
| **Market Microstructure & Execution Lab** | **Deterministic microstructure / execution analytics** on four sample instruments (BTCUSDT, SPY, CL futures, TSM equity): limit **order-book summary** (best bid/ask · mid · spread & **spread_bps** · **top-of-book & 5-level depth imbalance** · **microprice** & microprice-vs-mid) · **depth ladder** · **trade-tape** analytics (**VWAP** · **TWAP** · signed **trade imbalance** · buy/sell volume) · **execution analytics** (average fill price · fill ratio · **implementation shortfall** · **slippage** vs benchmark · **participation rate** · **square-root market-impact** approximation) · hypothetical **execution-schedule comparison** (Immediate / TWAP / VWAP-style / participation-of-volume → expected spread cost · impact · shortfall · completion) · eight **liquidity stress scenarios** (spread doubles · depth halves · volatility spike · volume drought · combo shock · bid-/ask-side pressure) · **TCA / execution-cost attribution** (arrival/VWAP/TWAP benchmark shortfalls · spread / impact / timing / fees / residual decomposition that reconciles to the realised shortfall) · **order-flow toxicity & liquidity metrics** (order-flow imbalance · queue imbalance · effective / realized spread · **adverse selection** · simplified **VPIN-style** toxicity · **Kyle lambda** · **Amihud illiquidity** · liquidity-regime classification · eight toxic-flow stress scenarios) · editable parent order — static sample data, no live order books or trades, no broker/exchange integration, VPIN-style metric is a simplified educational approximation (not exchange VPIN), not real-time toxicity detection, not a production execution / TCA system, not investment / trading / order-routing advice |
| **Crypto Perpetual Funding & Basis Lab** | **Deterministic crypto-derivatives analytics** on four sample markets (BTCUSDT perp · ETHUSDT perp · SOLUSDT perp · BTC quarterly futures): **perp basis** (& bps) · **dated-futures basis** & **annualized basis** `(F/S−1)·365/T` · **curve shape** (contango/backwardation/mixed/flat) · **funding** mechanics — 8h rate · **compound** `(1+f)^{3·365}−1` & **simple** annualized yield · **long/short funding P&L** · **position risk** (P&L · initial/maintenance margin · margin ratio · **approximate liquidation price & distance**) · **cash-and-carry** example (best contract · annualized basis · costs · gross carry) · **funding-regime classification** (neutral · positive/negative funding · overheated long perp · short-squeeze risk · basis carry rich · basis compressed) · ten **funding/basis stress scenarios** (funding spike +/− · perp premium blowout · perp discount · spot selloff/rally · basis convergence · margin stress · volatility shock) · editable market/position — static sample data, no live exchange data or crypto prices, no broker/exchange integration, funding/carry/liquidation are simplified educational approximations, not a production risk engine, not investment / trading / liquidation advice |
...
| **Formula reference (LaTeX)** | Every lab's "Formulas & notes" / "Key formulas" section renders as **locally-rendered KaTeX** (no math CDN, no MathJax, no remote script) via a shared `FormulaReference` / `SafeMath` component · grouped equations copy as clean **LaTeX source** · malformed formulas fall back to a styled code block (never crash the page) |
