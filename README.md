...
| **AFML Methodology Lab** | Leakage-aware financial-ML **labeling** toolkit: symmetric **CUSUM** event sampling · **triple-barrier** labeling (profit-take / stop-loss / vertical → +1 / −1 / 0) · sample **concurrency** · sample **uniqueness weights** — synthetic demo data, a labeling pipeline (not a trained model), purged CV / meta-labeling planned, not investment advice |
