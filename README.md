...
- **Options Lab v1 is a calculator, not an options risk engine.** It supports European Black–Scholes, Greeks, bisection IV, terminal payoff diagrams, and simplified CRR tree pricing for European/American exercise — no live chains, assignment, discrete-dividend/corporate-action modelling, liquidity, transaction costs, or volatility surface.
