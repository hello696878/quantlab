...
| **Real Estate Lab** | **Income-property + REIT analytics** on a deterministic static sample: **EGI / NOI** · in-place & exit **cap rate** valuation · **mortgage amortization** (with optional interest-only) · **LTV** · **DSCR** · **cash-on-cash** · levered cash flow · **IRR** (deterministic solver) · **equity multiple** · six **stress scenarios** (base · rent upside · vacancy shock · cap-rate expansion · interest-rate shock · downside combo) · simple **REIT NAV** discount/premium · P/FFO · dividend yield · editable assumptions — static sample data, not a production appraisal/underwriting tool, not investment / tax / legal / lending advice |
