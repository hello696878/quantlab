      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <span className="text-xs text-slate-400">
              Analyze deterministic sample growth, inflation, policy, liquidity, credit, and USD
              pressure scores with cross-asset assumptions, inverse-volatility weights, risk
              contributions, and macro stress scenarios — not investment, trading, or allocation
              advice.
            </span>
            <span className="mt-1 text-xs font-medium text-blue-600">
              Open Macro Regime Lab →
            </span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className="text-xs text-slate-400">
              Organize deterministic lab runs into saved research presets, compare baseline
              versus stressed outputs, write experiment notes, inspect reproducibility checks,
              and generate copy-friendly Markdown or JSON research summaries — not investment,
              trading, or compliance advice.
            </span>
            <span className="mt-1 text-xs font-medium text-blue-600">
          ...
          >
            ...
            <span className="text-xs text-slate-400">
              The public-presentation view: what QuantLab demonstrates, the suggested demo
              path, grouped highlights, and copyable recruiter/quant/technical pitches —
              static presentation copy, educational only.
            </span>
            <span className="mt-1 text-xs font-medium text-blue-600">
              Open Portfolio Showcase →
            </span>
          </button>
          <button
            type="button"
