...
const VERSION_LABEL = "4.66.0-dev";
const EXPECTED_NEXT_TAG = "v4.66.0-research-experiment-registry-v1";
const LATEST_VERIFIED_TAG = "v4.65.0-post-publication-verification-baseline-v1";
...
const CHANGELOG_CARDS: { tag: string; title: string; text: string }[] = [
  { tag: "v4.66 (next)", title: "Experiment registry", text: "Local-first SQLite registry of reproducibility metadata: deterministic fingerprints, a conservative reproducibility check, baseline scope, neutral comparison, JSON export, and demo records. Integrity aids only." },
