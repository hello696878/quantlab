...
const VERSION_LABEL = "4.74.0-dev";
const EXPECTED_NEXT_TAG = "v4.74.0-portfolio-risk-budget-constraint-diagnostics-v1";
const LATEST_VERIFIED_TAG = "v4.73.0-transaction-cost-slippage-capacity-diagnostics-v1";
